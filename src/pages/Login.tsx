    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-hearlink-50 to-blue-50 p-4">
      <div className="w-full max-w-2xl bg-white rounded-2xl overflow-hidden shadow-xl">
        <div className="bg-hearlink-600 py-6 text-white text-center">
          <h1 className="text-2xl font-bold">Welcome Back to HearLink</h1>
          <p className="mt-2">Choose your account type to log in</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8">
          <div className="bg-hearlink-50 rounded-xl p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Access learning tools optimized for hearing-impaired students
            </p>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              ...
              <Link to="/signup-student" className="text-hearlink-600 hover:underline">
                Sign up
              </Link>
            </p>
          </div>
          ...
          <div className="bg-hearlink-50 rounded-xl p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Manage your classes and create inclusive learning experiences
            </p>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Don't have an account?{" "}
              <Link to="/signup-teacher" className="text-hearlink-600 hover:underline">
                Sign up
              </Link>
            </p>
          </div>
